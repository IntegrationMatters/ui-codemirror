...
UiCodemirrorMergeDirective.$inject = ["$timeout", "uiCodemirrorMergeConfig", "CodeMirror"];
 ...
 *
 * @param $timeout
 * @param uiCodemirrorMergeConfig
 * @param CodeMirror
 * @returns {{restrict: string, require: string, compile: compile}}
 * @constructor
 */
function UiCodemirrorMergeDirective($timeout, uiCodemirrorMergeConfig, CodeMirror) {
  ...
  function postLink(scope, iElement, iAttrs, ngModel) {
    ...
    configOptionsWatcher(codemirror, iAttrs.uiCodemirrorMerge || iAttrs.uiCodemirrorMergeOpts, scope);
  ...
  function newCodemirrorEditor(iElement, codemirrorOptions) {
    ...
    /*iElement.html('');
    codemirror = CodeMirror.MergeView(iElement[0], codemirrorOptions);*/

    iElement.html('');
    codemirror = new CodeMirror.MergeView(iElement[0], codemirrorOptions, function (cm_el) {
